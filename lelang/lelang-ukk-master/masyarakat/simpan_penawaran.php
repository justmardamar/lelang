...
$sql = "INSERT INTO history_lelang (id_lelang,id_barang,id_user,penawaran_barang) values('$id_lelang','$id_barang','$id_user','$penawaran_barang'); UPDATE tb_lelang SET id_user='$id_user', harga_akhir='$penawaran_barang' WHERE id_lelang='$id_lelang' ";
